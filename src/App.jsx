...
const triggerHaptic = (type, enabled = true) => {
  ...
  try {
    ...
    else if (type === 'delete') navigator.vibrate(18);
    else if (type === 'submit') navigator.vibrate([20, 30, 20]);
    else if (type === 'win') navigator.vibrate([40, 60, 40, 60, 80]);
...
export default function App() {
  ...
  return (
    <div className="fixed inset-0 h-full w-full bg-[#12131C] text-slate-100 flex flex-col justify-between font-sans selection:bg-purple-500 selection:text-white overflow-hidden select-none overscroll-none touch-none">
            ...
            >
              {gameStatus === 'won' ? (
                ...
                <svg className="w-full h-full" viewBox="0 0 200 200">
                  ...
                  {/* LEFT HALF (CLIPPED TO X <= 100): Prevents center line bleed */}
