...
const triggerHaptic = (type, enabled = true) => {
  ...
  try {
    if (type === 'tap') navigator.vibrate(22);
    else if (type === 'delete') navigator.vibrate(32);
    else if (type === 'submit') navigator.vibrate([40, 50, 40]);
    else if (type === 'win') navigator.vibrate([60, 70, 60, 70, 120]);
    else if (type === 'error') navigator.vibrate([50, 60, 50]);
  } catch (e) {}
};
  ...
  return (
    ...
    >
      ...
      <main className="w-full flex-1 min-h-0 px-3 py-1 flex flex-col lg:flex-row items-center justify-evenly gap-3 lg:gap-8 overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center gap-1.5 lg:w-1/2 flex-shrink-0 h-auto lg:h-full">
